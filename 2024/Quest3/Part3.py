        ...
        for i in range(width):
            for j in range(height):
                ...
                if tile == '#':
                    grid[j][i] = 1
                    changes_made = True
                adj_tiles = [None, None, None, None, None, None, None, None]

                try:
                    adj_tiles[7] = grid[j+1][i+1]
                except:
                    adj_tiles.pop(7)

                try:
                    adj_tiles[6] = grid[j-1][i+1]
                except:
                    adj_tiles.pop(6)
                
                try:
                    adj_tiles[5] = grid[j-1][i-1]
                except:
                    adj_tiles.pop(5)

                try:
                    adj_tiles[4] = grid[j+1][i-1]
                except:
                    adj_tiles.pop(4)
